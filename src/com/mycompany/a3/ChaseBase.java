...
/**
 * This class is a strategy for NPRs.  It outlines how to chase the next Base.
 * 
 * @author Tim
 */
public class ChaseBase implements IStrategy {
	private NonPlayerRobot npRobot;
	
	public ChaseBase(NonPlayerRobot npr) {
		npRobot = npr;
	}
	...
	public void apply() {
		...
		while(it.hasNext()) {
			...
			if (go instanceof Base) {
				if (npRobot.getLastBase()+1 == ((Base)go).getSequenceNumber()) {
